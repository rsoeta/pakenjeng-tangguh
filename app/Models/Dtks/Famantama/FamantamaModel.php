...
class FamantamaModel extends Model
{
    ...
    function get_datatables($filter1, $filter2, $filter3)
    {
        ...
        if ($_POST['search']['value']) {
            ...
            $kondisi_search = "(fd_nama_lengkap LIKE '%$search%' OR fd_nkk LIKE '%$search%' OR fd_nik LIKE '%$search%') $kondisi_filter1 $kondisi_filter2 $kondisi_filter3";
        } else {
            $kondisi_search = "famantama_data.fd_id != '' $kondisi_filter1 $kondisi_filter2 $kondisi_filter3";
        }
    ...
    function jumlah_filter($filter1, $filter2, $filter3)
    {
        ...
        if ($_POST['search']['value']) {
            $search = $_POST['search']['value'];
            $kondisi_search = "AND (fd_nama_lengkap LIKE '%$search%' OR fd_nkk LIKE '%$search%' OR fd_nik LIKE '%$search%') $kondisi_filter1 $kondisi_filter2 $kondisi_filter3";
        } else {
