...
use App\Traits\WilayahFilterTrait; // 🚀 Panggil Trait di atas sini
...
class AnalisisDesil extends BaseController
{
    ...
    public function datatable()
    {
        try {
            ...
            // 🚀 TANGKAP DATA SESSION UNTUK GEMBOK WILAYAH
            ...
            // 1. Filter mutlak desa dari Session
            if (!empty($kodeDesa)) {
            ...
            foreach ($results as $row) {
                ...
                // ... (Logika potensi coret sebelumnya) ...
                ...
                // 🚀 RACIK TOMBOL MENUJU DETAIL KELUARGA
                $urlDetail = base_url('pembaruan-keluarga/detail/' . $row['id_kk']);
                $btnAksi = '<a href="' . $urlDetail . '" class="btn btn-sm btn-info shadow-sm font-weight-bold" target="_blank" title="Lihat Profil Keluarga"><i class="fas fa-external-link-alt mr-1"></i> Detail</a>';
                ...
                $data[] = [
                    ...
                    $prediksiNasib,
                    $btnAksi // 🚀 TAMBAHKAN TOMBOL DI BARIS TERAKHIR SINI
                ];
            }
