    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('saveInactive', ['class' => 'formsimpan']); ?>
                <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <div>
                            <?php
                            // echo  $role = session()->get('role_id');
                            ?>
                            <?php
                            // echo $kode_desa = session()->get('kode_desa');
                            ?>
                            <?php
                            // echo $kode_rw = session()->get('level');
                            ?>
                        </div>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_nama_kis" id="dpn_nama_kis" class="form-control form-control-sm" value="<?= set_value('dpn_nama_kis'); ?>" <?= $role > 3 ? 'readonly' : ''; ?>>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_noka_kis" id="dpn_noka_kis" class="form-control form-control-sm" value="<?= set_value('dpn_noka_kis'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_nik_kis" id="dpn_nik_kis" class="form-control form-control-sm" value="<?= set_value('dpn_nik_kis'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_tmp_lhr_kis" id="dpn_tmp_lhr_kis" class="form-control form-control-sm" value="<?= set_value('dpn_tmp_lhr_kis'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="date" name="dpn_tgl_lhr_kis" id="dpn_tgl_lhr_kis" class="form-control form-control-sm" value="<?= set_value('dpn_tgl_lhr_kis'); ?>">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="dpn_rw_kis" name="dpn_rw_kis" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($datarw as $row) { ?>
                                        <option value="<?= $row['no_rw'] ?>" <?= set_select('dpn_rw_kis', $row['no_rw']); ?>> <?php echo $row['no_rw']; ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="dpn_rt_kis" name="dpn_rt_kis" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($datart as $row) { ?>
                                        <option value="<?= $row['no_rt'] ?>" <?= set_select('dpn_rt_kis', $row['no_rt']); ?>> <?php echo $row['no_rt']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_alamat_kis" id="dpn_alamat_kis" class="form-control form-control-sm" value="<?= set_value('dpn_alamat_kis'); ?>">
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_nama_pm" id="dpn_nama_pm" class="form-control form-control-sm" value="<?= set_value('dpn_nama_pm'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_nkk_pm" id="dpn_nkk_pm" class="form-control form-control-sm" value="<?= set_value('dpn_nkk_pm'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_nik_pm" id="dpn_nik_pm" class="form-control form-control-sm" value="<?= set_value('dpn_nik_pm'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_tmp_lhr_pm" id="dpn_tmp_lhr_pm" class="form-control form-control-sm" value="<?= set_value('dpn_tmp_lhr_pm'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="date" name="dpn_tgl_lhr_pm" id="dpn_tgl_lhr_pm" class="form-control form-control-sm" value="<?= set_value('dpn_tgl_lhr_pm'); ?>">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="dpn_kode_desa" name="dpn_kode_desa" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($desKels as $row) { ?>
                                        <option <?= session()->get('kode_desa') == $row['id'] ? 'selected' : ''; ?> value="<?= $row['id'] ?>" <?= set_select('dpn_kode_desa', $row['id']); ?>> <?php echo $row['name']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding" <?php echo session()->get('role_id') > 3 ? 'hidden' : ''; ?>>
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="dpn_rw_pm" name="dpn_rw_pm" class="form-select form-select-sm">
                                    <option value="">-- Pilih RW --</option>
                                    <?php foreach ($datarw as $row) { ?>
                                        <option value="<?= $row['no_rw'] ?>" <?= set_select('dpn_rw_pm', $row['no_rw']); ?>> <?php echo $row['no_rw']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="dpn_rt_pm" name="dpn_rt_pm" class="form-select form-select-sm">
                                    <option value="">-Kosong-</option>
                                    <?php foreach ($datart as $row) { ?>
                                        <option value="<?= $row['no_rt'] ?>" <?= set_select('dpn_rt_pm', $row['no_rt']); ?>> <?php echo $row['no_rt']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="dpn_alamat_pm" id="dpn_alamat_pm" class="form-control form-control-sm" value="<?= set_value('dpn_alamat_pm'); ?>">
                    ...
                    <div class="modal-footer mt-3 justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary float-end btnSimpan"> Simpan</button>
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
