...
<div class="modal fade" id="modaltambah" tabindex="-1" aria-labelledby="modaltambahLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('dtks/tmbUsul', ['class' => 'formsimpan']) ?>
            <div class="modal-body">
                ...
                <div class="form-group row nopadding">
                    ...
                    <div class="col-8 col-sm-8">
                        <input type="number" name="nokk" id="nokk" class="form-control form-control-sm">
                ...
                <div class="form-group row nopadding">
                    ...
                    <div class="col-8 col-sm-8">
                        <input type="number" name="nik" id="nik" class="form-control form-control-sm">
                    ...
                    <div class="col-8 col-sm-8">
                        <select id="datart" name="datart" class="form-select form-select-sm">
                            ...
                            <?php foreach ($datart as $row) { ?>
                                <option value="<?= $row['id_rt']; ?>"> <?php echo $row['id_rt']; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="col-8 col-sm-8">
                        <select id="databansos" name="databansos" class="form-select form-select-sm">
                            ...
                            <?php foreach ($bansos as $row) { ?>
                                <option value="<?= $row['Id'] ?>"> <?php echo $row['NamaBansos']; ?></option>
                            <?php } ?>
                        </select>
