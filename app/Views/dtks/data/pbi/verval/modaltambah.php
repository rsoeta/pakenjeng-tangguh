    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('addpbi', ['class' => 'formsimpan'])
                ?>
                <?= csrf_field(); ?>
                <div class="row">
                    <div class="col-sm-6 col-12">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="datapisat" name="datapisat" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($datapisat as $row) { ?>
                                        <option value="<?= $row['id'] ?>" <?= set_select('datapisat', $row['id']); ?>> <?php echo $row['jenis_pisat']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding" <?php echo $role >= 4 ? 'hidden' : ''; ?>>
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="noka" id="noka" class="form-control form-control-sm" value="<?= set_value('noka'); ?>">
                            </div>
                        </div>
                        <div class="form-group row nopadding" <?php echo $role >= 4 ? 'hidden' : ''; ?>>
                            <label class="col-4 col-sm-4 col-form-label" for="ps_noka">PS NOKA</label>
                            <div class="col-8 col-sm-8">
                                <input type="text" name="ps_noka" id="ps_noka" class="form-control form-control-sm" value="<?= set_value('ps_noka'); ?>">
                            </div>
                        </div>
                        <div class="form-group row nopadding">
                            <label class="col-4 col-sm-4 col-form-label" for="kkno">No. KK</label>
                            <div class="col-8 col-sm-8">
                                <input type="text" name="kkno" id="kkno" class="form-control form-control-sm" value="<?= set_value('kkno'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="nama" id="nama" class="form-control form-control-sm" value="<?= set_value('nama'); ?>" <?= $role > 3 ? 'readonly' : ''; ?>>
                        ...
                        <?php if ($role <= 3) { ?>
                            <div class="form-group row nopadding">
                                ...
                                <div class="col-8 col-sm-8">
                                    <input type="text" name="nik_siks" id="nik_siks" class="form-control form-control-sm" value="<?= set_value('nik_siks'); ?>" <?= ($role == 1 || $role == 3) ? '' : 'readonly'; ?>>
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="jenkel" name="jenkel" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($jenisKelamin as $row) { ?>
                                        <option value="<?= $row['IdJenKel'] ?>" <?= set_select('jenkel', $row['IdJenKel']); ?>> <?php echo $row['NamaJenKel']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="tmplhr" id="tmplhr" class="form-control form-control-sm" value="<?= set_value('tmplhr'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="date" name="tgllhr" id="tgllhr" class="form-control form-control-sm" value="<?= set_value('tgllhr'); ?>">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="status_kawin" name="status_kawin" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($statusKawin as $row) { ?>
                                        <option value="<?= $row['idStatus'] ?>" <?= set_select('status_kawin', $row['idStatus']); ?>> <?php echo $row['StatusKawin']; ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="col-sm-6 col-12">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="kodepos" id="kodepos" class="form-control form-control-sm" value="<?= set_value('kodepos'); ?>">
                                <div class="invalid-feedback errorkodepos"></div>
                            </div>
                        </div>
                        <div class="form-group row nopadding" <?php echo session()->get('role_id') > 2 ? 'hidden' : ''; ?>>
                            <label class="col-4 col-sm-4 col-form-label" for="desa_kode">Nama Desa</label>
                            <div class="col-8 col-sm-8">
                                <select id="desa_kode" name="desa_kode" class="form-select form-select-sm">
                                    <option value="">-- Pilih Desa --</option>
                                    <?php foreach ($desKels as $row) { ?>
                                        <option <?= session()->get('kode_desa') == $row['id'] ? 'selected' : ''; ?> value="<?= $row['id'] ?>" <?= set_select('desa_kode', $row['id']); ?>> <?php echo $row['name']; ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="rw" name="rw" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($datarw as $row) { ?>
                                        <option value="<?= $row['no_rw'] ?>" <?= set_select('rw', $row['no_rw']); ?>> <?php echo $row['no_rw']; ?></option>
                                    <?php } ?>
                                </select>
                                <div class="invalid-feedback errorrw"></div>
                            </div>
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="rt" name="rt" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($datart as $row) { ?>
                                        <option value="<?= $row['no_rt'] ?>" <?= set_select('rt', $row['no_rt']); ?>> <?php echo $row['no_rt']; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="alamat" id="alamat" class="form-control form-control-sm" value="<?= set_value('alamat'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="nmayah" id="nmayah" class="form-control form-control-sm" value="<?= set_value('nmayah'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="nikayah" id="nikayah" class="form-control form-control-sm" value="<?= set_value('nikayah'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="nmibu" id="nmibu" class="form-control form-control-sm" value="<?= set_value('nmibu'); ?>">
                        ...
                        <div class="form-group row nopadding">
                            ...
                            <div class="col-8 col-sm-8">
                                <input type="text" name="nikibu" id="nikibu" class="form-control form-control-sm" value="<?= set_value('nikibu'); ?>">
                            ...
                            <div class="col-8 col-sm-8">
                                <select id="status" name="status" class="form-select form-select-sm">
                                    ...
                                    <?php foreach ($status as $row) { ?>
                                        <option value="<?= $row['id_status'] ?>"> <?php echo $row['jenis_status']; ?></option>
                                    <?php } ?>
                                </select>
                                ...
                                <div class="col-8 col-sm-8">
                                    <select id="verivali_pbi" name="verivali_pbi" class="form-select form-select-sm">
                                        ...
                                        <?php foreach ($verivali_pbi as $row) { ?>
                                            <option value="<?= $row['vp_id'] ?>" <?= set_select('verivali_pbi'); ?>> <?php echo $row['vp_keterangan']; ?></option>
                                        <?php } ?>
                                    </select>
