...
?>
<!-- Modal -->
<div class="modal fade" id="modalMati" tabindex="-1" aria-labelledby="modalMatiLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="col-11 modal-title text-center" id="modalMatiLabel"><?= $title; ?></h5>
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row nopadding">
                                <label for="status" class="col-5 col-sm-4 col-form-label">Status</label>
                            ...
                            <div class="form-group row nopadding">
                                <label for="pendidikan" class="col-5 col-sm-4 col-form-label">Tanggal Meninggal</label>
                                <div class="col-7 col-sm-8">
                                    <input type="date" name="tanggal_meninggal" id="tanggal_meninggal" class="form-control form-control-sm">
                                    <div class="invalid-feedback errortglMeninggal"></div>
                                </div>
                            </div>
                            <div class="form-group row nopadding">
                                <label for="pendidikan" class="col-5 col-sm-4 col-form-label">No. Reg Meninggal</label>
                                <div class="col-7 col-sm-8">
                                    <input type="text" name="no_registrasi_meninggal" id="no_registrasi_meninggal" class="form-control form-control-sm">
                ...
                success: function(response) {
                    if (response.error) {
                        ...
                        if (response.error.tanggal_meninggal) {
                            ...
                            $('.errortglMeninggal').html(response.error.tanggal_meninggal);
                        } else {
                            $('#tanggal_meninggal').removeClass('is-invalid');
                            $('.errortglMeninggal').html('');
                        }
