                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div <?php if ($level > 3) {
                                            echo 'hidden';
                                        } ?> class="form-group row nopadding">
                                    <label class="col-4 col-sm-4 col-form-label" for="id_dtks">ID DTKS</label>
                                    <div class="col-8 col-sm-8">
                                        <input type="text" name="id_dtks" id="id_dtks" class="form-control form-control-sm" value="<?= set_value('id_dtks', $db_id_dtks); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row nopadding">
                                    ...
                                    <div class="col-8 col-sm-8">
                                        <input type="number" name="id_data" id="id_data" class="form-control form-control-sm" value="<?= set_value('dusun', $dusun); ?>">
