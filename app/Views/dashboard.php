                                    ...
                                    <table class="table table-sm table-hover table-bordered compact" style="width: 100%;">
                                            ...
                                            <?php foreach ($countStatusBnba as $count) : ?>
                                                <tr>
                                                    ...
                                                    <?php foreach ($dtks_status as $count2) : ?>
                                                        <td style="text-align: right;"><?= number_format($count->{$count2->jenis_status}); ?></td>
                                                    <?php endforeach; ?>
                                                    <td style="text-align: right;"><?= number_format($count->Capaian); ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                        <tfoot class="table-primary">
                                            <tr>
                                                ...
                                                <?php endforeach; ?>
                                                <th style="text-align: right;"><?= number_format($grandTotalAll); ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
